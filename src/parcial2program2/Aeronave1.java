...
public class Aeronave1 implements MovAvion{
    ...
    public void Aterrizar() {
        ...
        while (op!=1&&op!=2){
            String ind;
            ind = JOptionPane.showInputDialog("La aeronave 1 va a aterrizar\n"
                + "1. Si\n"
                + "2. No");
            op = Integer.parseInt(ind);
            
            if (op==1){
                JOptionPane.showMessageDialog(null, "La aeronave 1 aterrizo");
            }else if(op==2){
                JOptionPane.showMessageDialog(null, "La aeronave 1 sigue en vuelo");
    ...
    public void Despegar() {
        ...
        while (op!=1&&op!=2){
            String ind;
            ind = JOptionPane.showInputDialog("La aeronave 1 va a despegar\n"
                + "1. Si\n"
                + "2. No");
            op = Integer.parseInt(ind);
            
            if (op==1){
                JOptionPane.showMessageDialog(null, "La aeronave 1 despego");
            }else if(op==2){
                JOptionPane.showMessageDialog(null, "La aeronave 1 sigue en tierra");
    ...
    public void IngresarDatos (){
        JOptionPane.showMessageDialog(null, "DATOS DE LA AERONAVE 1");
    ...
    public void ImprimirDatos(){
        ...
        JOptionPane.showMessageDialog(null, "AERONAVE 1\n"+"\n"+"Tipo de Aeronave: "+Tipo+
                "\nModelo: "+Modelo+
